 ...
 * 
 * Uso: node src/scripts/list-pdfs.js [tenantId]
 * 
 * Ejemplo:
 *   node src/scripts/list-pdfs.js
 *   node src/scripts/list-pdfs.js 507f1f77bcf86cd799439012
 */
...
const listPdfs = async () => {
  try {
    ...
    console.log(`   node src/scripts/delete-pdf.js <pdfId> [tenantId] [userId]\n`);
